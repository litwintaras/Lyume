...
_STRINGS = {
    "uk": {
        ...
        "summary_redo_hint": "Хочете щось змінити? Введіть номер [bold](1-5)[/bold] щоб переробити крок.",
    ...
    "en": {
        ...
        "summary_redo_hint": "Want to change something? Enter a number [bold](1-5)[/bold] to redo that step.",
